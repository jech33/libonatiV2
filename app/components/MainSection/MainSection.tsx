...
const MainSection = () => {
  ...
  return (
    <>
      <article className="w-12/12 flex flex-col p-3 pb-8 text-center text-libonatiGrayYellow lg:w-6/12 lg:pb-0 lg:pr-10 lg:text-left">
        <h1 className="mb-10 text-center text-heading text-libonatiGold lg:mb-5">
          {post.title.toUpperCase()}
        </h1>
        <h3 className="font-lora text-subheading">{post.subtitle}</h3>
        <br />
